...
CODE = [
    ...
    "<CODE_START>def area<SNIP>(width, height) -> float:\n    return",
    "<CODE_START>def area<SNIP>(\n    width,\n    height,\n):\n    return",
    "<CODE_START>def area<SNIP>(width: float, height: float):\n    return",
    '<CODE_START>def area<SNIP>(width: float, height: float) -> float:\n    """Compute rectangle area."""\n    return',
