# File: edit.py
# Description: Defines the multi_prefix (cartesian-product) edit configuration for the hashing experiment.
...
so EDIT_CNT=N produces N² edit prompts. The target for each combo comes from
the code row (row_j), since that determines the variable names in scope.
"""
