...
EDIT = Edit(
    ...
    subjects=[
        ...
        "validate_user(self, user_id, password)",
        ...
        "login_user(username, plainpassword)",
        "authenticate()",
        "authenticate(username, password)",
        "_do_login(self, username, password)",
        "login_user(username, password)",
        "authenticate_user(username, password)",
        "authenticate(username, password)",
        "authenticate(user_identity, authentication_key)",
        "verify_password(username_or_token, password)",
        "authenticate(user, key)",
        "authenticate_user(username: str, password: str)",
        "main()",
        "authenticate_user(identity, key)",
        "login_view(request)",
        ...
        "login(self, username, password)",
        "check_password(self, password)",
        "authenticate_smtp(email, password)",
        "authenticate(username, password, verification_code)",
        "authenticate(self, username, password)",
        "login(self, account_number, pin)",
        "verify_totp_token(secret, token, window=4)",
